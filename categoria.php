...
include("ecommerce.action/CategoriaAction.php"); 
include("conn/configuracao.php");
?>
<?php 
$headerAction = new HeaderAction();
$menuAction = new MenuAction();
$categoriaAction = new CategoriaAction();
?>
        ...
        <div class="corpo">
            <div id="menu_lateral">
                <?php 
                    ...
                    $lista = $categoriaAction->recuperarSubCategorias();
                    echo "<table>";
                        echo "<tr>";    
            ...
            <div id="onde_estou">
                <?php
                    ...
                    echo "<a href='index.php'>Home</a> > $nome_categoria";
                ?>
            </div>
            <div id="produtos_destaque">
                <?php

                $lista = $categoriaAction->recuperarProdutoCategoria();
